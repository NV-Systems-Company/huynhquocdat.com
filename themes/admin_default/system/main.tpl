...
<div class="container-fluid nvwrap">
	...
	<header id="header" class="row">
		<div class="logo">
			<a title="{NV_SITE_NAME}" href="{NV_BASE_SITEURL}{NV_ADMINDIR}/index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}">
				<span class="logo-md">Admin<strong>CP</strong></span>
	...
	<footer id="footer" class="row">
		<div class="footer-content">
			...
			<div class="footer-pys">
				<div class="copyright text-right">
					<small>Được phát triển bởi</small> <strong>HUỲNH QUỐC ĐẠT</strong> - <strong><small>Website:</small></strong> <a href="https://huynhquocdat.com" target="_blank">huynhquocdat.com</a>
					<br><strong><small>Email:</small></strong> <a href="mailto:dat@vuta.vn">dat@vuta.vn</a> - <strong><small>Điện thoại:</small></strong> <a href="tel:0866628896"><strong>086.662.8896</strong></a>
				</div>
			</div>
		</div>
	</footer>
