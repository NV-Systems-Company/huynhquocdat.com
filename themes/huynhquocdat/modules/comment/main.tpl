...
<div id="idcomment" class="nv-fullbg">
    ...
    <!-- BEGIN: showContent -->
    <div class="mb-3">
        <button type="button" class="btn btn-default btn-show-comment" onclick="nv_show_hidden('showcomment',2);"><em class="fa fa-caret-square-o-down"></em>&nbsp; {LANG.comment_hide_show}</button>
    </div>
    <div id="showcomment" class="mb-3">
        {COMMENTCONTENT}
    </div>
    <!-- END: showContent -->
    <div id="formcomment" class="comment-form">
        ...
        <form method="post" role="form" target="submitcommentarea" action="{FORM_ACTION}" data-module="{MODULE_COMM}" data-content="{MODULE_DATA}_commentcontent" data-area="{AREA_COMM}" data-id="{ID_COMM}" data-allowed="{ALLOWED_COMM}" data-checkss="{CHECKSS_COMM}" data-gfxnum="{GFX_NUM}" data-editor="{EDITOR_COMM}"<!-- BEGIN: enctype --> enctype="multipart/form-data"<!-- END: enctype -->>
            ...
            <div class="form-group clearfix">
                <textarea class="form-control" style="width: 100%" name="content" id="commentcontent" cols="20" rows="5" placeholder="Nhập nội dung"></textarea>
                <!-- BEGIN: editor -->
            ...
            <div class="form-group text-center">
                <input id="buttoncontent" type="submit" value="{LANG.comment_submit}" class="btn btn-default btn-submit-comment" />
            </div>
        </form>
