...
$lang_module['titlesetup'] = 'Cài đặt website';
...
$lang_module['congratulations'] = 'Xin chúc mừng!!! Bạn đã cài đặt thành công hệ thống Website. Bạn cần đăng nhập vào khu vực quản trị để tiến hành các bước cấu hình site.';
$lang_module['notesupport'] = 'Mọi nhu cầu về hỗ trợ kỹ thuật xin liên hệ tại <a href="http://quocdatit.com" target="_blank"><strong>Quốc Đạt IT</strong></a>.';
...
$lang_module['copyright'] = 'Chú ý: Việc đăng lại bài viết trên ở website hoặc các phương tiện truyền thông khác mà không ghi rõ nguồn http://quocdatit.com là vi phạm bản quyền';
...
$lang_module['update_site_title_update'] = 'Nâng cấp Website';
$lang_module['update_site_title_upgrade'] = 'Cập nhật Website';
